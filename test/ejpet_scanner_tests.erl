...
tokenize_test_() ->
    Tests = [
             ...
             {"***",
              [star, star, star]},
             {"<{_:42}>",
              [open_angle_brace, open_curvy_brace, underscore, column, {number, 42}, close_curvy_brace, close_angle_brace]},
             {"{ _ : < {_: 42 } >}",
              [open_curvy_brace, underscore, column, open_angle_brace,
               open_curvy_brace, underscore, column, {number, 42}, close_curvy_brace, close_angle_brace, close_curvy_brace]},
             ...
             {"<\"foo\"{_:42[]}:<!!>>",
              [open_angle_brace, {string, <<"foo">>}, open_curvy_brace, underscore, column, {number, 42}, open_square_brace, close_square_brace, close_curvy_brace, column, open_angle_brace_bang, close_angle_brace_bang, close_angle_brace]},
             {"?<my_var1>",
              [{capture, "my_var1"}]},
             {"\"string\"#\"regex\"",
